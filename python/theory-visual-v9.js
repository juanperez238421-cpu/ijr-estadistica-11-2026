...
`<div class="v9-errors" aria-label="Errors as diagnostic information"><div class="v9-error-types"><div style="--d:0s"><b>SyntaxError</b><span>syntax problem</span></div><div style="--d:1.2s"><b>NameError</b><span>name problem</span></div><div style="--d:2.4s"><b>TypeError</b><span>type problem</span></div></div><div class="v9-diagnose"><div style="--d:3.6s"><b>1</b><strong>READ</strong><span>the message</span></div><i></i><div style="--d:4.6s"><b>2</b><strong>IDENTIFY</strong><span>the category</span></div><i></i><div style="--d:5.6s"><b>3</b><strong>CORRECT</strong><span>one controlled thing</span></div><i></i><div style="--d:6.6s"><b>4</b><strong>RUN AGAIN</strong><span>inspect feedback</span></div></div></div>`,

`<div class="v9-bridge" aria-label="From one value to statistics"><i class="v9-bridge-line"></i>${[['17','one value','single calculation'],['x','variables','named values'],['[ ]','lists','many observations'],['T/F','logic','compare / decide'],['↺','loops','repeat procedure'],['f(x)','functions','reuse procedure'],['Σ','statistics','summaries']].map((x,i)=>`<div style="--d:${i*.65}s"><b>${x[0]}</b><span>${x[1]}</span><small>${x[2]}</small></div>`).join('')}</div><div class="v9-bridge-caption"><span>one calculation</span><i></i><span>structured data</span><i></i><span>repeatable analysis</span><i></i><span>statistical summary</span></div>`
  ];
